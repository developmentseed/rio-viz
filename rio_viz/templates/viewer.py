    ...
    const set1bViz = () => {{
      ...
      switch (vizType) {{
        ...
        case 'point':
          map.addSource('mvt', {{
            type: 'vector',
            url: `${{api_endpoint}}/tilejson.json?tile_format=pbf&feature_type=point&resampling_method=${{params.resampling_method}}`
          }})
          addLayer(vizType)
          break
        ...
        case 'polygon':
          map.addSource('mvt', {{
            type: 'vector',
            url: `${{api_endpoint}}/tilejson.json?tile_format=pbf&feature_type=polygon&resampling_method=${{params.resampling_method}}`
          }})
          addLayer(vizType)
          break
